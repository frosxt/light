 ...
 *
 * @author Crypto Morin
 * @link <a href="https://github.com/CryptoMorin/XSeries/blob/master/src/main/java/com/cryptomorin/xseries/XMaterial.java">...</a>
 * @version 11.4.0
 * @see Material
 * @see ItemStack
 */
public enum XMaterial {
    ...
    XMaterial(final int data, @Nonnull final String... legacy) {
        this.data = (byte) data;
        this.legacy = legacy;
    ...
    XMaterial(final String... legacy) {this(0, legacy);}
    ...
    public static XMaterial matchXMaterial(@Nonnull final ItemStack item) {
        ...
        final byte data = (byte) (Data.ISFLAT || material.equals("MAP") || item.getType().getMaxDurability() > 0 ? 0 : item.getDurability());
     ...
     */
    @Nullable
    public XMaterial or(@Nullable final XMaterial alternateMaterial) {
